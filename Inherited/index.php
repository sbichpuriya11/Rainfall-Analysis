            ...
            <nav class="navbar navbar-expand-lg navbar-transparent py-2">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0 p-4">
                        <input class="form-control mr-sm-2" type="search" placeholder="Search By City or Postcode"
                    ...
                    <a href="" data-toggle="modal" type="button" class="btn btn-danger" data-placement=" bottom" data-target="#mymodal"><strong>IN <i class="fas fa-globe-asia"></i> |  C &deg; <i class="fas fa-caret-down"></i></strong></a> 
...
<div class="accordion py-3" id="accordionExample">
  <div class="card z-depth-0 bordered">
    <div class="card-header" id="headingOne">
      <h5 class="mb-0">
        <button class="btn btn-link w-100 text-left text-decoration-none" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
          Asia
        </button>
      </h5>
    </div>
  ...
  <div class="card z-depth-0 bordered">
    <div class="card-header" id="headingTwo">
      <h5 class="mb-0">
        <button class="btn btn-link w-100 text-left collapsed text-decoration-none" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Africa
        </button>
      </h5>
    </div>
  ...
  <div class="card z-depth-0 bordered">
    <div class="card-header" id="headingThree">
      <h5 class="mb-0">
        <button class="btn btn-link w-100 text-left text-decoration-none collapsed" type="button" data-toggle="collapse"
